...
@OpenAPIDefinition(info = @Info(title = "Ecommerce Project Api With Springboot",
...
version = "v1", contact = @Contact(name = "Ashok", 
email = "ashokpanhalkar28@gmail.com"), 
license = @License(name = "Code With Ashok")))
public class JunitTestMockitoApplication {

	public static void main(String[] args) {
		SpringApplication.run(JunitTestMockitoApplication.class, args);
	}
